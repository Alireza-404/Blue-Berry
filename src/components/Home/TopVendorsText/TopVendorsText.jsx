...
export default function TopVendorsText() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context((self) => {
      ...
      tl.from(self.selector("#top-vendors-text"), {
        y: 60,
        opacity: 0,
        ease: "power3.out",
        duration: 0.3,
      }).from(self.selector("#top-vendors-sec-text"), {
        y: 60,
        opacity: 0,
        ease: "power3.out",
        duration: 0.3,
